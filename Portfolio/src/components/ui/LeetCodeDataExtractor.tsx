...
export function LeetCodeDataExtractor({ onDataExtracted }: LeetCodeDataExtractorProps) {
  ...
  const extractFromLeetCode = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Found your LeetCode profile! Total solved: ${data.totalSolved}. Please use manual input for submission history.`);
...
# Add your submission dates here...`}
              ...
              <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                <p>Format: One line per day, date and count separated by comma</p>
                <p>Example: 2024-01-15, 2 (means 2 problems solved on Jan 15, 2024)</p>
              </div>
              <button
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md">
          <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2">How to get your data:</h4>

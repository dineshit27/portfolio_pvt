...
export function ProjectCard({ title, description, image, link, github, isOngoing, techStack, index = 0 }: ProjectCardProps) {
  return (
    <motion.div
    ...
    >
      <motion.div
        ...
        className="relative bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 rounded-2xl shadow-lg overflow-hidden transition duration-300 hover:shadow-blue-500/10"
      >
            ...
            {techStack.map((item, index) => {
              ...
              return (
                <div key={index} className="relative">
                  <div className="peer p-2 rounded-lg bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
